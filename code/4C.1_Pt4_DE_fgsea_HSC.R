...
res_tbl_all
#Save the table
write.csv(res_tbl_all,"results/Pt4/DEA/DEA_pt4_HSC.csv" )
...
write.csv(sig_res_all, "results/Pt4/DEA/DEA_pt4_HSC_padj.csv")
...
## 1. Read in data -----------------------------------------------------------
list.files(in_path)
df_new <- read.csv("results/Pt4/DEA/DEA_pt4_HSC_padj.csv", row.names = 1)
...
#Check whether it worked
head(GSEAres_GO)
write_csv(GSEAres_GO, "results/Pt4/DEA/GSEA_HSC_pt4_GO.csv")
...
#Save
## 5. Save the results -----------------------------------------------
saveRDS(GSEAres_GO, file = "results/Pt4/fgsea/GSEA_pt4_BL_REL_HSC_GO.rds")
data.table::fwrite(GSEAres_GO, file ="results/Pt4/fgsea/GSEA_pt9_BL_REL_HSC_GO.tsv" , sep = "\t", sep2 = c("", " ", ""))
...
#Save
saveRDS(GSEAres_KEGG, file = "results/GSEA_pt4_BL_REL_LHSC_KEGG.rds")
data.table::fwrite(GSEAres_KEGG, file ="results/GSEA_pt4_BL_REL_HSC_KEGG.tsv" , sep = "\t", sep2 = c("", " ", ""))
