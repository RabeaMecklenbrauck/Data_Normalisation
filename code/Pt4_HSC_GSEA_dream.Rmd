...
out_path <- "results/pt4/results/DREAM"
in_path<-"results/"
...
head(GSEAres_GO)
write_csv(GSEAres_GO, "results/pt4/results/DREAM/GSEA_HSC_pt4_GO_dream.csv")
...
ggsave("GO_pathways_dream2_pt4_HSC.pdf", path = "results/Pt4/results/Figures", width =10, height = 10, unit = "cm")

#Save
#Save the results -----------------------------------------------
data.table::fwrite(GSEAres_GO, file ="results/pt4/results/DREAM/GSEA_pt4_BL_REL_HSC_GO_dream.tsv" , sep = "\t", sep2 = c("", " ", ""))
```
...
#Check whether it worked
head(GSEAres_KEGG)
write_csv(GSEAres_KEGG,"results/Pt4/results/DREAM/GSEA_pt4_HSC_KEGG_dream.csv")
...
ggsave("KEGG_pt4_HSC_dream.pdf", path = "results/Pt4/results/Figures", width =20, height = 30, unit = "cm")
#Save
data.table::fwrite(GSEAres_KEGG, file ="results/Pt4/results/DREAM/GSEA_pt4_BL_REL_HSC_KEGG_dream.tsv" , sep = "\t", sep2 = c("", " ", ""))
```
######HALLMARK
...
write_csv(GSEAres_HALLMARK,"results/Pt4/results/DREAM/GSEA_pt4_HSC_HALLMARK_dream.csv")
...
#Save
data.table::fwrite(GSEAres_HALLMARK, file ="results/Pt4/results/DREAM/GSEA_pt4_BL_REL_HSC_HALLMARK_dream.tsv" , sep = "\t", sep2 = c("", " ", ""))
```
...
ggsave("HALLMAR_pt4_HSC_dream_dream.pdf", path = "results/Pt4/results/Figures", width =25, height = 30, unit = "cm")
```
```{r}
head(GSEAres_HALLMARK)
```
...
#Check whether it worked
head(GSEAres_all)
write_csv(GSEAres_all,"results/Pt4/results/DREAM/GSEA_pt4_HSC_pathways_dream.csv")
...
#Save
data.table::fwrite(GSEAres_all, file ="results/Pt4/results/DREAM/GSEA_pt4_BL_REL_HSC_all_dream.tsv" , sep = "\t", sep2 = c("", " ", ""))
...
ggsave("allPathways_pt4_HSC_Dream.pdf", path = "results/Pt4/results/Figures", width =20, height = 35, unit = "cm")
```
...
bg_genes<-bg_genes[bg_genes$gene%in%dream$Gene,]
```
...
ggsave("Hallmark_pt4_HSC_Dream_dotplot.pdf", path = "results/Pt4/results/Figures", width =20, height = 35, unit = "cm")
```
...
ggsave("Hallmark_pt4_HSC_Dream_dotplot_all.pdf", path = "results/Pt4/results/Figures", width =20, height = 35, unit = "cm")
```