...
out_path <- "results/pt14/results/Deseq2"
in_path<-"results/"
...
head(GSEAres_GO)
write_csv(GSEAres_GO, "results/pt14/results/Deseq2/GSEA_LMPP_pt14_GO.csv")
...
#Save
#Save the results -----------------------------------------------
data.table::fwrite(GSEAres_GO, file ="results/pt14/results/Deseq2/GSEA_pt14_BL_REL_LMPP_GO.tsv" , sep = "\t", sep2 = c("", " ", ""))
```
...
#Check whether it worked
head(GSEAres_KEGG)
write_csv(GSEAres_KEGG,"results/Pt14/results/Deseq2/GSEA_pt14_LMPP_KEGG.csv")
...
ggsave("KEGG_pt14_LMPP_Deseq.pdf", path = "results/Pt14/results/Figures", width =10, height = 10, unit = "cm")
#Save
data.table::fwrite(GSEAres_KEGG, file ="results/Pt14/results/Deseq2/GSEA_pt14_BL_REL_LMPP_KEGG.tsv" , sep = "\t", sep2 = c("", " ", ""))
```
...
write_csv(GSEAres_HALLMARK,"results/Pt14/results/Deseq2/GSEA_pt14_LMPP_HALLMARK.csv")
...
#Save
data.table::fwrite(GSEAres_HALLMARK, file ="results/Pt14/results/Deseq2/GSEA_pt14_BL_REL_LMPP_HALLMARK.tsv" , sep = "\t", sep2 = c("", " ", ""))
```
...
ggsave("HALLMAR_pt14_LMPP_Deseq.pdf", plot = correlation, path = "results/Pt14/results/Figures", width =10, height = 10, unit = "cm")
```
```{r}
...
ggsave("HALLMARK_pt14_LMPP_Deseq.pdf", path = "results/Pt14/results/Figures", width =25, height = 18, unit = "cm")
```
```{r}
GSEAres_HALLMARK_sig$NES_inv<-GSEAres_HALLMARK_sig$NES*(-1)
ggplot(GSEAres_HALLMARK_sig, aes(x = NES_inv, y = fct_reorder(pathway, NES_inv))) + 
               geom_point(aes(size = NES_inv, color = GSEAres_HALLMARK_sig$padj)) +
               theme_bw(base_size = 14) +
        scale_colour_gradient(limits=c(0, 0.10), low="red") +
        ylab(NULL) +
        ggtitle("HALLMARK pathway enrichment")
ggsave("HALLMARK_pt14_LMPP_Deseq_inv.pdf", path = "results/Pt14/results/Figures", width =25, height = 18, unit = "cm")
```
...
#Check whether it worked
head(GSEAres_all)
write_csv(GSEAres_all,"results/Pt14/results/Deseq2/GSEA_pt14_LMPP_pathways.csv")
...
#Save
data.table::fwrite(GSEAres_all, file ="results/Pt14/results/Deseq2/GSEA_pt14_BL_REL_LMPP_all.tsv" , sep = "\t", sep2 = c("", " ", ""))
...
ggsave("allPathways_pt14_LMPP_Deseq.pdf", path = "results/Pt14/results/Figures", width =20, height = 35, unit = "cm")
```
...
```{r}
enrichplot::dotplot(enrichres_Hallmark, x = "geneRatio",showCategory = 15, orderBy = "p.adjust", split) 
ggsave("Hallmark_pt14_LMPP_Deseq_dotplot.pdf", path = "results/Pt14/results/Figures", width =20, height = 35, unit = "cm")
```
...
ggsave("Hallmark_pt14_LMPP_Deseq_dotplot_all.pdf", path = "results/Pt14/results/Figures", width =20, height = 35, unit = "cm")
```