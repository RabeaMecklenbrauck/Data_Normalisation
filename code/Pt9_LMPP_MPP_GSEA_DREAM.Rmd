---
title: "Pt9_LMPP_MPP_MPP_GSEA_dream"
...
out_path <- "results/pt9/results/DREAM"
in_path<-"results/"
...
#according to this list KEGG = [9], GO = [53], reactome = [17], wikipathways [21], misigdb [69], this script uses KEGG, GO and Misigdb
#GO pathways
...
head(GSEAres_GO)
write_csv(GSEAres_GO, "results/pt9/results/DREAM/GSEA_LMPP_MPP_pt9_GO_dream.csv")
...
ggsave("GO_pathways_deseq2_pt9_LMPP_MPP.pdf", path = "results/Pt9/results/Figures", width =10, height = 10, unit = "cm")

#Save
#Save the results -----------------------------------------------
data.table::fwrite(GSEAres_GO, file ="results/pt9/results/DREAM/GSEA_pt9_BL_REL_LMPP_MPP_GO_dream.tsv" , sep = "\t", sep2 = c("", " ", ""))
```
...
#Check whether it worked
head(GSEAres_KEGG)
write_csv(GSEAres_KEGG,"results/Pt9/results/DREAM/GSEA_pt9_LMPP_MPP_KEGG_dream.csv")
...
ggsave("KEGG_pt9_LMPP_MPP_dream.pdf", path = "results/Pt9/results/Figures", width =20, height = 30, unit = "cm")
#Save
data.table::fwrite(GSEAres_KEGG, file ="results/Pt9/results/DREAM/GSEA_pt9_BL_REL_LMPP_MPP_KEGG_dream.tsv" , sep = "\t", sep2 = c("", " ", ""))
```
######HALLMARK
...
write_csv(GSEAres_HALLMARK,"results/Pt9/results/DREAM/GSEA_pt9_LMPP_MPP_HALLMARK_dream.csv")
...
#Save
data.table::fwrite(GSEAres_HALLMARK, file ="results/Pt9/results/DREAM/GSEA_pt9_BL_REL_LMPP_MPP_HALLMARK_dream.tsv" , sep = "\t", sep2 = c("", " ", ""))
```
...
ggsave("HALLMAR_pt9_LMPP_MPP_Deseq_dream.pdf", path = "results/Pt9/results/Figures", width =25, height = 30, unit = "cm")
```
```{r}
head(GSEAres_HALLMARK)
```
...
#Check whether it worked
head(GSEAres_all)
write_csv(GSEAres_all,"results/Pt9/results/DREAM/GSEA_pt9_LMPP_MPP_pathways_dream.csv")
...
#Save
data.table::fwrite(GSEAres_all, file ="results/Pt9/results/DREAM/GSEA_pt9_BL_REL_LMPP_MPP_all_dream.tsv" , sep = "\t", sep2 = c("", " ", ""))
...
ggsave("allPathways_pt9_LMPP_MPP_Dream.pdf", path = "results/Pt9/results/Figures", width =20, height = 35, unit = "cm")
```
...
ggsave("Hallmark_pt9_LMPP_MPP_Dream_dotplot.pdf", path = "results/Pt9/results/Figures", width =20, height = 35, unit = "cm")
```
...
ggsave("Hallmark_pt9_LMPP_MPP_Dream_dotplot_all.pdf", path = "results/Pt9/results/Figures", width =20, height = 35, unit = "cm")
```