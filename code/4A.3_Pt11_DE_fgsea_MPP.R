...
#Check whether it worked
head(GSEAres_GO)
write_csv(GSEAres_GO, "results/pt11/fgsea/GSEA_MPP_pt11_GO.csv")
...
#Save
## 5. Save the results -----------------------------------------------
saveRDS(GSEAres_GO, file = "results/Pt11/fgsea/GSEA_pt11_BL_REL_MPP_GO.rds")
data.table::fwrite(GSEAres_GO, file ="results/Pt11/fgsea/GSEA_pt11_BL_REL_MPP_GO.tsv" , sep = "\t", sep2 = c("", " ", ""))
...
#Check whether it worked
head(GSEAres_KEGG)
write_csv(GSEAres_KEGG,"results/Pt11/fgsea/GSEA_pt11_MPP_KEGG.csv")
...
#Save
saveRDS(GSEAres_KEGG, file = "results/Pt11/fgsea/GSEA_pt11_BL_REL_MPP_KEGG.rds")
data.table::fwrite(GSEAres_KEGG, file ="results/Pt11/fgsea/GSEA_pt11_BL_REL_MPP_KEGG.tsv" , sep = "\t", sep2 = c("", " ", ""))
...
write_csv(GSEAres_HALLMARK,"results/Pt11/fgsea/GSEA_pt11_MPP_HALLMARK.csv")
...
#Save
saveRDS(GSEAres_HALLMARK, file = "results/Pt11/fgsea/GSEA_pt11_BL_REL_LMPP_HALLMARK.rds")
data.table::fwrite(GSEAres_HALLMARK, file ="results/Pt11/fgsea/GSEA_pt11_BL_REL_LMPP_HALLMARK.tsv" , sep = "\t", sep2 = c("", " ", ""))
#Visualise
