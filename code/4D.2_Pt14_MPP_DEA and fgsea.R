...
#According to the table the major clone at BL and at REL is mainly found in the continuum of MPP and LMPP
#We'll start do MPP
##Create a subset with only dominant population which is MPP in this case
pt14_BL_REL<-subset(x=pt14_BL_REL, subset=predicted_CellType %in% c("MPP-MkEry", "MPP-MyLy"))
...
res_tbl_all
#Save the table
write.csv(res_tbl_all,"results/Pt14/DEA/DEA_pt14_MPP.csv" )
...
write.csv(sig_res_all, "results/Pt14/DEA/DEA_pt14_MPP_padj.csv")
...
## 1. Read in data -----------------------------------------------------------
list.files(in_path)
df_new <- read.csv("results/Pt14/DEA/DEA_pt14_MPP_padj.csv", row.names = 1)
...
#Check whether it worked
head(GSEAres_GO)
write_csv(GSEAres_GO, "results/Pt14/DEA/GSEA_MPP_pt14_GO.csv")
...
#Save
## 5. Save the results -----------------------------------------------
saveRDS(GSEAres_GO, file = "results/Pt14/fgsea/GSEA_pt14_BL_REL_MPP_GO.rds")
data.table::fwrite(GSEAres_GO, file ="results/Pt14/fgsea/GSEA_pt14_BL_REL_MPP_GO.tsv" , sep = "\t", sep2 = c("", " ", ""))
...
#Check whether it worked
head(GSEAres_KEGG)
write_csv(GSEAres_KEGG,"results/Pt14/fgsea/GSEA_pt14_MPP_KEGG.csv")
...
#Save
saveRDS(GSEAres_KEGG, file = "results/Pt14/fgsea/GSEA_pt14_BL_REL_MPP_KEGG.rds")
data.table::fwrite(GSEAres_KEGG, file ="results/Pt14/fgsea/GSEA_pt14_BL_REL_MPP_KEGG.tsv" , sep = "\t", sep2 = c("", " ", ""))
...
write_csv(GSEAres_HALLMARK,"results/Pt14/fgsea/GSEA_pt14_MPP_Hallmark.csv")
...
#Save
saveRDS(GSEAres_HALLMARK, file = "results/Pt14/fgsea/GSEA_pt14_BL_REL_MPP_HALLMARK.rds")
data.table::fwrite(GSEAres_HALLMARK, file ="results/Pt14/fgsea/GSEA_pt4_BL_REL_MPP_HALLMARK.tsv" , sep = "\t", sep2 = c("", " ", ""))
