...
res_tbl_all
#Save the table
write.csv(res_tbl_all,"results/Pt14/DEA/DEA_pt14_LMPP.csv" )
...
write.csv(sig_res_all, "results/Pt14/DEA/DEA_pt14_LMPP_padj.csv")
...
## 1. Read in data -----------------------------------------------------------
list.files(in_path)
df_new <- read.csv("results/Pt14/DEA/DEA_pt14_LMPP_padj.csv", row.names = 1)
...
#Check whether it worked
head(GSEAres_GO)
write_csv(GSEAres_GO, "results/Pt14/DEA/GSEA_LMPP_pt14_GO.csv")
...
#Save
## 5. Save the results -----------------------------------------------
saveRDS(GSEAres_GO, file = "results/Pt14/fgsea/GSEA_pt14_BL_REL_LMPP_GO.rds")
data.table::fwrite(GSEAres_GO, file ="results/Pt14/fgsea/GSEA_pt14_BL_REL_LMPP_GO.tsv" , sep = "\t", sep2 = c("", " ", ""))
...
#Check whether it worked
head(GSEAres_KEGG)
write_csv(GSEAres_KEGG,"results/Pt14/fgsea/GSEA_pt14_LMPP_KEGG.csv")
...
#Save
saveRDS(GSEAres_KEGG, file = "results/Pt14/fgsea/GSEA_pt14_BL_REL_LMPP_KEGG.rds")
data.table::fwrite(GSEAres_KEGG, file ="results/Pt14/fgsea/GSEA_pt14_BL_REL_LMPP_KEGG.tsv" , sep = "\t", sep2 = c("", " ", ""))
...
write_csv(GSEAres_HALLMARK,"results/Pt14/fgsea/GSEA_pt14_LMPP_Hallmark.csv")
...
#Save
saveRDS(GSEAres_HALLMARK, file = "results/Pt14/fgsea/GSEA_pt14_BL_REL_LMPP_HALLMARK.rds")
data.table::fwrite(GSEAres_HALLMARK, file ="results/Pt14/fgsea/GSEA_pt4_BL_REL_LMPP_HALLMARK.tsv" , sep = "\t", sep2 = c("", " ", ""))
