...
out_path <- "results/pt11/results/DREAM"
in_path<-"results/"
...
head(GSEAres_GO)
write_csv(GSEAres_GO, "results/pt11/results/DREAM/GSEA_LMPP_pt11_GO_dream.csv")
...
#Save
#Save the results -----------------------------------------------
data.table::fwrite(GSEAres_GO, file ="results/pt11/results/DREAM/GSEA_pt11_BL_REL_LMPP_GO_dream.tsv" , sep = "\t", sep2 = c("", " ", ""))
```
...
#Check whether it worked
head(GSEAres_KEGG)
write_csv(GSEAres_KEGG,"results/Pt11/results/DREAM/GSEA_pt11_LMPP_KEGG_dream.csv")
...
ggsave("KEGG_pt11_LMPP_dream.pdf", path = "results/Pt11/results/Figures", width =20, height = 30, unit = "cm")
#Save
data.table::fwrite(GSEAres_KEGG, file ="results/Pt11/results/DREAM/GSEA_pt11_BL_REL_LMPP_KEGG_dream.tsv" , sep = "\t", sep2 = c("", " ", ""))
```
######HALLMARK
...
write_csv(GSEAres_HALLMARK,"results/Pt11/results/DREAM/GSEA_pt11_LMPP_HALLMARK_dream.csv")
...
#Save
data.table::fwrite(GSEAres_HALLMARK, file ="results/Pt11/results/DREAM/GSEA_pt11_BL_REL_LMPP_HALLMARK_dream.tsv" , sep = "\t", sep2 = c("", " ", ""))
```
...
ggsave("HALLMAR_pt11_LMPP_Deseq_dream.pdf", path = "results/Pt11/results/Figures", width =25, height = 30, unit = "cm")
```
```{r}
head(GSEAres_HALLMARK)
```
...
#Check whether it worked
head(GSEAres_all)
write_csv(GSEAres_all,"results/Pt11/results/DREAM/GSEA_pt11_LMPP_pathways_dream.csv")
...
#Save
data.table::fwrite(GSEAres_all, file ="results/Pt11/results/DREAM/GSEA_pt11_BL_REL_LMPP_all_dream.tsv" , sep = "\t", sep2 = c("", " ", ""))
...
ggsave("allPathways_pt11_LMPP_Dream.pdf", path = "results/Pt11/results/Figures", width =20, height = 35, unit = "cm")
```
...
ggsave("Hallmark_pt11_LMPP_Dream_dotplot.pdf", path = "results/Pt11/results/Figures", width =20, height = 35, unit = "cm")
```
...
ggsave("Hallmark_pt11_LMPP_Dream_dotplot_all.pdf", path = "results/Pt11/results/Figures", width =20, height = 35, unit = "cm")
```
